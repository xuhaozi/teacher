...
public class CustomMediaPlayerAssertFolder extends JZMediaInterface implements MediaPlayer
        .OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer
        .OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer
        .OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public void prepare() {
        try {
            ...
            AssetFileDescriptor assetFileDescriptor = (AssetFileDescriptor) jzDataSource
                    .getCurrentUrl();
